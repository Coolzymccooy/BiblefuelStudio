...
export function Layout() {
    ...
    return (
      ...
      `}>
            ...
            {/* Main Content Area */}
            <main className="flex-1 overflow-y-auto h-screen relative scroll-smooth selection:bg-primary-500/30">
                ...
                <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 relative z-10 pb-24 animate-fade-in">
                    <Outlet />
                </div>
            </main>
